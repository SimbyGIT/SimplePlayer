...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        '
        resources.ApplyResources(Me.Playlist1ToolStripMenuItem, "Playlist1ToolStripMenuItem")
        Me.Playlist1ToolStripMenuItem.Name = "Playlist1ToolStripMenuItem"
        '
        'Playlist2ToolStripMenuItem
        '
        resources.ApplyResources(Me.Playlist2ToolStripMenuItem, "Playlist2ToolStripMenuItem")
        Me.Playlist2ToolStripMenuItem.Name = "Playlist2ToolStripMenuItem"
        '
        'Playlist3ToolStripMenuItem
        '
        resources.ApplyResources(Me.Playlist3ToolStripMenuItem, "Playlist3ToolStripMenuItem")
        Me.Playlist3ToolStripMenuItem.Name = "Playlist3ToolStripMenuItem"
        '
        'Playlist4ToolStripMenuItem
        '
        resources.ApplyResources(Me.Playlist4ToolStripMenuItem, "Playlist4ToolStripMenuItem")
        ...
        '
        resources.ApplyResources(Me.CreateSaveAPlaylistToolStripMenuItem, "CreateSaveAPlaylistToolStripMenuItem")
        ...
        '
        resources.ApplyResources(Me.RadioPlayerX10ToolStripMenuItem, "RadioPlayerX10ToolStripMenuItem")
...
End Sub
    ...
    Friend WithEvents ImportDeleteToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ImportASongToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ToolStripSeparator9 As ToolStripSeparator
    Friend WithEvents OpenPlaylistToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents Playlist1ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents Playlist2ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents Playlist3ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents Playlist4ToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ToolStripSeparator1 As ToolStripSeparator
    Friend WithEvents CreateSaveAPlaylistToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ToolStripSeparator23 As ToolStripSeparator
    Friend WithEvents DeleteSelectedItemToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents DeleteAllToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents ToolStripSeparator2 As ToolStripSeparator
    Friend WithEvents ExitToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents PlayerOptionsToolStripMenuItem As ToolStripMenuItem
    Friend WithEvents RadioPlayerX10ToolStripMenuItem As ToolStripMenuItem
