Public Class Playlist
    ...
    Private Sub Playlist_add_but_Click(sender As Object, e As EventArgs) Handles MyBase.Click
    ...
    Private Sub Playlist_add_but_Click_2(sender As Object, e As EventArgs) Handles Playlist_add_but.Click
